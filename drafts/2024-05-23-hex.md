...
$$
\begin{align*}
    X(k_1, k_2) = \sum_{n_1=0}^{N_1} \sum_{n_2=0}^{N_2} x(n_1, n_2) \exp\bigg(-2\pi i \bigg(\frac{(k_1(n_1 - n_2/2)}{N_1} + \frac{k_2 n_2}{N_2}\bigg) \bigg)
\end{align*}
$$


|![Screenshot 2024-05-24 at 9 54 23 PM](https://github.com/chris-langfield/chris-langfield.github.io/assets/34426450/20eddfaf-8d57-4b75-a467-b497c4d08c1b)|
| :--: |
| Rectangular region |
